...
public class BestMenuListViewAdapter extends BaseAdapter {

    // Adapter에 추가된 데이터를 저장하기 위한 ArrayList
    private ArrayList<BestMenuListViewItem> MenuListViewItemList = new ArrayList<BestMenuListViewItem>() ;

    // ListViewAdapter의 생성자
    public BestMenuListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.best_menu_listview_item, parent, false);
        }

        // 화면에 표시될 View(Layout이 inflate된)으로부터 위젯에 대한 참조 획득
        ImageView rankImageView = (ImageView) convertView.findViewById(R.id.tv_rank);
        ...
        // 아이템 내 각 위젯에 데이터 반영
        rankImageView.setImageDrawable(bestMenuListViewItem.getRank());
    ...
    public void addItem(Drawable rank, Drawable icon, String title, String count) {
